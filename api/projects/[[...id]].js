// GET  /api/projects          -> approved projects (all for admin)
// POST /api/projects          -> submit project (student auth)
// GET  /api/projects/:id      -> single project
// PATCH /api/projects/:id     -> approve/reject (admin)
// DELETE /api/projects/:id    -> delete (admin or owner)
...
module.exports = async function handler(req, res) {
  ...
  if (!id) {
    ...
    if (req.method === 'POST') {
      ...
      await kvRequest(['HSET', `project:${pid}`,
        'id', pid, 'studentId', user.id, 'studentName', user.name,
